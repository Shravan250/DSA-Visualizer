...
export default function Home() {
  return (
    <main className="min-h-screen relative">
        ...
        <div className="relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p
              ...
              style={{ fontFamily: "Young Serif", fontStyle: "italic" }}
            >
            ...
            <div className="flex justify-center gap-4">
              <Link href="/dashboard">
                <Button
                  variant="default"
                  className="bg-[#68B7A4] text-white px-8 py-3 rounded-full hover:bg-[#5aa090] transition-colors"
                >
                  EXPLORE
                </Button>
              </Link>
              <Button
                variant="outline"
                className="text-gray-500 flex items-center gap-2 border px-8 py-3 rounded-full hover:bg-gray-50 transition-colors"
              >
                <Image
      ...
      {/* Features Section */}
      <section className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 place-items-center">
        <div className="space-y-8">
          <Card className="border-none shadow-none mb-0">
            <CardContent className="flex gap-4 items-center border-b-2 border-gray-300 pb-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Our algorithms are as fast as possible, there is no way
          ...
          <Card className="border-none shadow-none mb-0">
            <CardContent className="flex gap-4 items-start border-b-2 border-gray-300 pb-4">
              <div className="w-16 h-16">
                <Image
        ...
        <Card className="bg-gray-100 rounded-lg aspect-video flex items-center justify-center">
          <CardContent>
      ...
      <section className="bg-[#68B7A4] py-16">
        <div className="max-w-4xl mx-auto px-6">
          <Card className="bg-transparent border-none shadow-none">
            <CardContent className="flex flex-col md:flex-row items-center gap-8 text-white">
